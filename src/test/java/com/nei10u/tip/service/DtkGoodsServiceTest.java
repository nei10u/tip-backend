...
import com.nei10u.tip.service.impl.GoodsServiceImpl;
...
public class DtkGoodsServiceTest {
    ...
    public void testConvertLink_Tb() {
        ...
        // GoodsServiceImpl.convertLink 当前未传 pid，使用 null
        when(dtkApiService.getPrivilegeLink(eq("123456"), isNull(), isNull(), isNull(), isNull()))
                .thenReturn(mockResponse);

        JSONObject result = goodsService.convertTbLink("tb", "123456", "user1");
